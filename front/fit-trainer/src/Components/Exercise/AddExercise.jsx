...
import { addExercise } from '../../Redux/actions/exercises';
...
//     addExercise: (userId, title, measurement) => dispatch(addExercise(userId, title, measurement))
// })

export default connect(mapStateToProps, {addExercise})(AddEx);